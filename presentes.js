...
(function () {
  ...
  const GIFTS = {
    ...
    vinhos:        { name: 'Vinhos da Costa Esmeralda',                   price: 220,
                     pix: '#', card: '#' },
    vinicola:      { name: 'Passeio pelas vinícolas de Gallura',          price: 280,
                     pix: '#', card: '#' },
    jantar:        { name: 'Jantar em Trastevere Sardo',                  price: 350,
                     pix: '#', card: '#' },
    massagem:      { name: 'Massagem relaxante com vista para o mar',     price: 450,
                     pix: '#', card: '#' },
    'tour-gastro': { name: 'Tour gastronômico pela Sardenha',             price: 550,
                     pix: '#', card: '#' },
    barco:         { name: 'Passeio de barco pelo arquipélago de La Maddalena', price: 700,
                     pix: '#', card: '#' },
    diaria:        { name: 'Diária em hotel boutique na Costa Esmeralda', price: 850,
                     pix: '#', card: '#' },
